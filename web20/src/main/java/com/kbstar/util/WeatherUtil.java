...
public class WeatherUtil {
    public static String getWeather1(String loc) throws Exception {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8") + "=mxxB2eyBPN1bjroNYzNlZ2HgXDKiJQ89yrdiy8H%2Fmeo5ciG%2BhtzLZxDxCCa%2BUApYHsJxz9bUMRHARDGFrmuY1Q%3D%3D"); /*Service Key*/
        ...
        rd.close();
        conn.disconnect();
        //아침엔 Java Object -> JSON
        //지금은 JSON  -> Java Object 하는 중..
